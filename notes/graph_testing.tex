...
(1 - \delta_n) x^T L x \leq x^T \overline{L} x \leq (1 + \delta_n) x^T L x~~\textrm{for all}~x \in \Reals^n, \delta_n = \frac{c \log n}{n}
\end{equation}
...
\paragraph{Proof of~\eqref{eqn:bottleneck}:} \textcolor{red}{TODO}:
