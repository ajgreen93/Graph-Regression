...
data_directory <- "data/laplacian_eigenmaps/testing/eigenfunction_2d_2s"
plot_directory <- "plots/laplacian_eigenmaps/testing/eigenfunction" # Please change this to whichever directory you prefer.
