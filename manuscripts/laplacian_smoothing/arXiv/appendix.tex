...
When $\rho = 0$, the Laplacian smoother $\wh{f} = \mathbf{Y}$, the test statistic $\wh{T} = \frac{1}{n}\|\mathbf{Y}\|_2^2$, and the threshold $\wh{t}_{\alpha} = 1 + 2bn^{-1/2}$. The expectation of $\wh{T}$ is 
\begin{equation*}
