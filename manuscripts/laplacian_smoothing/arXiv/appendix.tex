...
\end{equation*}
where the last inequality follows by taking $C_6 \geq C_7 \sqrt{p_{\max}/p_{\min}}$. \sbcomment{I'm confused about the last inequality. Are you missing squares on the last term, i.e. $(\Ebb\bigl[\norm{f}_n^2\bigr])^2$ ? I think the problem repeats below but I could be just missing something.}
...
\paragraph{Bounds on $\Leb^2(\Xset)$ error under Lipschitz assumption.} \sbcomment{This is a nice result but where do you reference it or use it?}
