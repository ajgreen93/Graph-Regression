...
\onecolumn	
\aistatstitle{Supplementary Material for ``Minimax Optimal Regression over
  Sobolev Spaces via Laplacian Regularization on Neighborhood Graphs''}
...
\end{equation}
Now, noticing that $\bigl\|\wt{\mc{P}}f\bigr\|_{n} = \bigl\|\wt{\mc{P}}^{\star}\wt{\mc{P}}f\bigr\|_{\wt{P}_n}$, we can use the upper bound \eqref{pf:prop_isometry_1} to show that
\begin{align}
